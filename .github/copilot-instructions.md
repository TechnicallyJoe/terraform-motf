...
This file and `.claude/CLAUDE.md` share the same project conventions. Additional Claude Code-specific guidance lives in `.claude/CLAUDE.md` below the shared conventions section. When updating project conventions, update **both files**.
